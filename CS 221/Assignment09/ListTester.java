...
public class ListTester {
	...
	private void runTests() {
		...
		Integer[] LIST_BCD = {ELEMENT_B, ELEMENT_C, ELEMENT_D};
		String STRING_BCD = "BCD";
		Integer[] LIST_ACD = {ELEMENT_A, ELEMENT_C, ELEMENT_D};
		String STRING_ACD = "ACD";
		...
		testEmptyList(newList, "newList");																			//1) no list -> constructor -> []
		testSingleElementList(emptyList_addToFrontA_A, "emptyList_addToFrontA_A", LIST_A, STRING_A);				//2) [] -> addToFront(A) -> [A]
		testSingleElementList(emptyList_addToRearA_A, "emptyList_addToRearA_A", LIST_A, STRING_A);					//3) [] -> addToRear(A) -> [A]
		testSingleElementList(emptyList_addA_A, "emptyList_addA_A", LIST_A, STRING_A);								//4) [] -> add(A) -> [A]
		testSingleElementList(emptyList_add0A_A, "emptyList_add0A_A", LIST_A, STRING_A);							//5) [] -> add(0,A) -> [A]
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA);								//6) [A] -> addToFront(B) -> [B,A]
		testTwoElementList(A_addToRearB_AB, "A_addToRearB_AB", LIST_AB, STRING_AB);									//7) [A] -> addToRear(B) -> [A,B]
		testTwoElementList(A_addAfterA_AB, "A_addAfterA_AB", LIST_AB, STRING_AB);									//8) [A] -> addAfter(B,A) -> [A,B]
		testTwoElementList(A_addB_AB, "A_addB_AB", LIST_AB, STRING_AB);												//9) [A] -> add(B) -> [A,B]
		testTwoElementList(A_add0_BA, "A_add0_BA", LIST_BA, STRING_BA);												//10) [A] -> add(0,B) -> [B,A]
		testTwoElementList(A_add1_AB, "A_add1_AB", LIST_AB, STRING_AB);												//11) [A] -> add(1,B) -> [A,B]
		testEmptyList(A_removeFirst_emptyList, "A_removeFront_emptyList");											//12) [A] -> removeFirst() -> []
		testEmptyList(A_removeLast_emptyList, "A_removeLast_emptyList");											//13) [A] -> removeLast() -> []
		testEmptyList(A_removeA_emptyList, "A_removeA_emptyList");													//14) [A] -> removeA -> []
		testEmptyList(A_remove0_emptyList, "A_remove0_emptyList");													//15) [A] -> remove0 -> []
		testSingleElementList(A_set0_B, "A_set0_B", LIST_B, STRING_B);												//16) [A] -> set(0,B) -> [B]
		testThreeElementList(BC_addToFrontA_ABC, "BC_addToFrontA_ABC", LIST_ABC, STRING_ABC);						//17) [B,C] -> addToFront(C) -> [A,B,C]
		testThreeElementList(AB_addToRearC_ABC, "AB_addToRearC_ABC", LIST_ABC, STRING_ABC);							//18) [A,B] -> addToRear(C) -> [A,B,C]
		testThreeElementList(AB_addAfterCA_ACB, "AB_addAfterCA_ACB", LIST_ACB, STRING_ACB);							//19) [A,B] -> addAfter(C,A) -> [A,C,B]
		testThreeElementList(AB_addAfterCB_ABC, "AB_addAfterCB_ABC", LIST_ABC, STRING_ABC);							//20) [A,B] -> addAfter(C,B) -> [A,B,C]
		testThreeElementList(AB_addC_ABC, "AB_addC_ABC", LIST_ABC, STRING_ABC);										//21) [A,B] -> add(C) -> [A,B,C]
		testThreeElementList(AB_add0C_CAB, "AB_add0C_CAB", LIST_CAB, STRING_CAB);									//22) [A,B] -> add(0,C) -> [C,A,B]
		testThreeElementList(AB_add1C_CAB, "AB_add1C_ACB", LIST_ACB, STRING_ACB);									//23) [A,B] -> add(1,C) -> [A,C,B]
		testThreeElementList(AB_add2C_CAB, "AB_add2C_ACB", LIST_ABC, STRING_ABC);									//24) [A,B] -> add (2,C) -> [A,B,C]
		testSingleElementList(BA_removeFirst_A, "BA_removeFront_A", LIST_A, STRING_A);								//25) [B,A] -> removeFirst() -> [A]
		testSingleElementList(AB_removeLast_A, "AB_removeLast_A", LIST_A, STRING_A);								//26) [A,B] -> removeLast() -> [A]
		testSingleElementList(AB_removeA_B, "AB_removeA_B", LIST_B, STRING_B);										//27) [A,B] -> remove(A) -> [B]
		testSingleElementList(AB_removeB_A, "AB_removeB_A", LIST_A, STRING_A);										//28) [A,B] -> remove(B) -> [A]
		testSingleElementList(AB_remove0_B, "AB_remove0_B", LIST_B, STRING_B);										//29) [A,B] -> remove(0) -> [B]
		testSingleElementList(AB_remove1_A, "AB_remove1_A", LIST_A, STRING_A);										//30) [A,B] -> remove(1) -> [A]
		testTwoElementList(CA_set0_BA, "CA_set0_BA", LIST_BA, STRING_BA);											//31) [C,A] -> set(0,B) -> [B,A]
		testTwoElementList(BC_set1_BA, "BC_set1_BA", LIST_BA, STRING_BA);											//32) [B,C] -> set(1,A) -> [B,A]
		testTwoElementList(ABC_removeFirst_BC, "ABC_removeFirst_BC", LIST_BC, STRING_BC);							//33) [A,B,C] -> removeFirst() -> [B,C]
		testTwoElementList(ABC_removeLast_AB, "ABC_removeLast_AB", LIST_AB, STRING_AB);								//34) [A,B,C] -> removeLast() -> [A,B]
		testTwoElementList(ABC_removeA_BC, "ABC_removeA_BC", LIST_BC, STRING_BC);									//35) [A,B,C] -> remove(A) -> [B,C]
		testTwoElementList(ABC_removeB_AC, "ABC_removeB_AC", LIST_AC, STRING_AC);									//36) [A,B,C] -> remove(B) -> [A,C]
		testTwoElementList(ABC_removeC_AB, "ABC_removeC_AB", LIST_AB, STRING_AB);									//37) [A,B,C] -> remove(C) -> [A,B]
		testTwoElementList(ABC_remove0_BC, "ABC_remove0_BC", LIST_BC, STRING_BC);									//38) [A,B,C] -> remove(0) -> [B,C]
		testTwoElementList(ABC_remove1_AC, "ABC_remove1_AC", LIST_AC, STRING_AC);									//39) [A,B,C] -> remove(1) -> [A,C]
		testTwoElementList(ABC_remove2_AB, "ABC_remove2_AB", LIST_AB, STRING_AB);									//40) [A,B,C] -> remove(2) -> [A,B]
		testThreeElementList(ABC_set0D_DBC, "ABC_set0D_DBC", LIST_DBC, STRING_DBC);									//41) [A,B,C] -> set(0,D) -> [D,B,C]
		testThreeElementList(ABC_set1D_ADC, "ABC_set1D_ADC", LIST_ADC, STRING_ADC);									//42) [A,B,C] -> set(1,D) -> [A,D,C]
		testThreeElementList(ABC_set2D_ABD, "ABC_set2D_ABD", LIST_ABD, STRING_ABD);									//43) [A,B,C] -> set(2,D) -> [A,B,D]
		
																													//including Iterator remove() method, add the following:
		testEmptyList(A_IterRemoveA_empty, "A_IterRemoveA_empty");													//44) [A] -> iterator remove() after next() returns A -> []
		testSingleElementList(AB_IterRemoveA_B, "AB_IterRemoveA_B", LIST_B, STRING_B);								//45) [A,B] -> iterator remove() after next() returns A -> [B]
		testSingleElementList(AB_IterRemoveB_A, "AB_IterRemoveB_A", LIST_A, STRING_A);								//46) [A,B] -> iterator remove() after next() returns B -> [A]
		testTwoElementList(ABC_IterRemoveA_BC, "ABC_IterRemoveA_BC", LIST_BC, STRING_BC);							//47) [A,B,C] -> iterator remove() after next() returns A -> [B,C]
		testTwoElementList(ABC_IterRemoveB_AC, "ABC_IterRemoveB_AC", LIST_AC, STRING_AC);							//48) [A,B,C] -> iterator remove() after next() returns B -> [A,C]
		testTwoElementList(ABC_IterRemoveC_AB, "ABC_IterRemoveC_AB", LIST_AB, STRING_AB);							//49) [A,B,C] -> iterator remove() after next() returns C -> [A,B]
		
																													//including ListIterator with remove(), add(), and set() methods:
		testEmptyList(A_IterListRemoveA_empty, "A_IterListRemoveA_empty");											//50) [A] -> iteratorList remove() after next() returns A -> []
		testSingleElementList(AB_IterListRemoveA_B, "AB_IterListRemoveA_B", LIST_B, STRING_B);						//51) [A,B] -> iteratorList remove() after next() returns A -> [B]
		testSingleElementList(AB_IterListRemoveB_A, "AB_IterListRemoveB_A", LIST_A, STRING_A);						//52) [A,B] -> iteratorList remove() after next() returns B -> [A]
		testTwoElementList(ABC_IterListRemoveA_BC, "ABC_IterRemoveA_BC", LIST_BC, STRING_BC);						//53) [A,B,C] -> iteratorList remove() after next() returns A -> [B,C]
		testTwoElementList(ABC_IterListRemoveB_AC, "ABC_IterListRemoveB_AC", LIST_AC, STRING_AC);					//54) [A,B,C] -> iteratorList remove() after next() returns B -> [A,C]
		testTwoElementList(ABC_IterListRemoveC_AB, "ABC_IterListRemoveC_AB", LIST_AB, STRING_AB);					//55) [A,B,C] -> iteratorList remove() after next() returns C -> [A,B]
		testEmptyList(A_ListIterRemovePrevious_empty, "A_ListIterRemovePrevious_empty");							//56) [A] -> iterator remove() after previous() returns A -> []
		testSingleElementList(AB_ListIterRemovePrevious_B, "AB_ListIterRemovePrevious_B", LIST_B, STRING_B);		//57) [A,B] -> iterator remove() after previous() returns A -> [B]
		testSingleElementList(AB_ListIterRemovePrevious_A, "AB_ListIterRemovePrevious_A", LIST_A, STRING_A);		//58) [A,B] -> iterator remove() after previous() returns B -> [A]
		testTwoElementList(ABC_ListIterRemovePrevious_BC, "ABC_ListIterRemovePrevious_BC", LIST_BC, STRING_BC);		//59) [A,B,C] -> iterator remove() after previous() returns A -> [B,C]
		testTwoElementList(ABC_ListIterRemovePrevious_AC, "ABC_ListIterRemovePrevious_AC", LIST_AC, STRING_AC);		//60) [A,B,C] -> iterator remove() after previous() returns B -> [A,C]
		testTwoElementList(ABC_ListIterRemovePrevious_AB, "ABC_ListIterRemovePrevious_AB", LIST_AB, STRING_AB);		//61) [A,B,C] -> iterator remove() after previous() returns C -> [A,B]
		testSingleElementList(empty_ListIterAddA_A, "empty_ListIterAddA_A", LIST_A, STRING_A);						//62) [] -> iterator add(A) -> [A]
		testTwoElementList(A_ListIteraddB_AB, "A_ListIterAddB_AB", LIST_AB, STRING_AB);								//63) [A] -> iterator add(B) with new iterator -> [B,A]
		testTwoElementList(A_ListIterNextAddB_AB, "A_ListIterNextAddB_AB", LIST_AB, STRING_AB);						//64) [A] -> iterator add(B) after next() returns A -> [A,B]
		testTwoElementList(A_ListIterPreviousAddB_BA, "A_ListIterPreviousAddB_BA", LIST_BA, STRING_BA);				//65) [A] -> iterator add(B) after previous() returns A -> [B,A]
		testThreeElementList(AB_ListIterAddC_CAB, "AB_ListIterAddC_CAB", LIST_CAB, STRING_CAB);						//66) [A,B] -> iterator add(C) with new iterator -> [C,A,B]
		testThreeElementList(AB_ListIterAddC_ACB, "AB_ListIterAddC_ACB", LIST_ACB, STRING_ACB);						//67) [A,B] -> iterator add(C) after next() returns A -> [A,C,B]
		testThreeElementList(AB_ListIterAddC_ABC, "AB_ListIterAddC_ABC", LIST_ABC, STRING_ABC);						//68) [A,B] -> iterator add(C) after next() returns B -> [A,B,C]
		testThreeElementList(AB_ListIterPreviousAddC_CAB, "AB_ListIterPreviousAddC_CAB", LIST_CAB, STRING_CAB);		//69) [A,B] -> iterator add(C) after previous() returns A -> [C,A,B]
		testThreeElementList(AB_ListIterPreviousAddC_ACB, "AB_ListIterPreviousAddC_ACB", LIST_ACB, STRING_ACB);		//70) [A,B] -> iterator add(C) after previous() returns B -> [A,C,B]
		testSingleElementList(A_ListIterNextSetB_B, "A_ListIterNextSetB_B", LIST_B, STRING_B);						//71) [A] -> iterator set(B) after next() returns A -> [B]
		testSingleElementList(A_ListIterPreviousSetB_B, "A_ListIterPreviousSetB_B", LIST_B, STRING_B);				//72) [A] -> iterator set(B) after previous() returns A -> [B]
		testTwoElementList(AB_ListIterNextSetC_CB, "AB_ListIterNextSetC_CB", LIST_CB, STRING_CB);					//73) [A,B] -> iterator set(C) after next() returns A -> [C,B]
		testTwoElementList(AB_ListIterNextSetC_AC, "AB_ListIterNextSetC_AC", LIST_AC, STRING_AC);					//74) [A,B] -> iterator set(C) after next() returns B -> [A,C]
		testTwoElementList(AB_ListIterPreviousSetC_CB, "AB_ListIterPreviousSetC_CB", LIST_CB, STRING_CB);			//75) [A,B] -> iterator set(C) after previous() returns A -> [C,B]
		testTwoElementList(AB_ListIterPreviousSetC_AC, "AB_ListIterPreviousSetC_AC", LIST_AC, STRING_AC);			//76) [A,B] -> iterator set(C) after previous() returns B -> [A,C]
		testThreeElementList(ABC_ListIterNextSetD_DBC, "ABC_ListIterNextSetD_DBC", LIST_DBC, STRING_DBC);			//77) [A,B,C] -> iterator set(D) after next() returns A -> [D,B,C]
		testThreeElementList(ABC_ListIterNextSetD_ADC, "ABC_ListIterNextSetD_ADC", LIST_ADC, STRING_ADC);			//78) [A,B,C] -> iterator set(D) after next() returns B -> [A,D,C]
		testThreeElementList(ABC_ListIterNextSetD_ABD, "ABC_ListIterNextSetD_ABD", LIST_ABD, STRING_ABD);			//79) [A,B,C] -> iterator set(D) after next() returns C -> [A,B,D]
		testThreeElementList(ABC_ListIterPreviousSetD_DBC, "ABC_ListIterPreviousSetD_DBC", LIST_DBC, STRING_DBC);		//80) [A,B,C] -> iterator set(D) after previous() returns A -> [D,B,C]
		testThreeElementList(ABC_ListIterPreviousSetD_ADC, "ABC_ListIterPreviousSetD_ADC", LIST_ADC, STRING_ADC);	//81) [A,B,C] -> iterator set(D) after previous() returns B -> [A,D,C]
		testThreeElementList(ABC_ListIterPreviousSetD_ABD, "ABC_ListIterNextSetD_ABD", LIST_ABD, STRING_ABD);		//82) [A,B,C] -> iterator set(D) after previous() returns C -> [A,B,D]
																													
																													//homebrew 
		testSingleElementList(AD_removeElementD_A, "AD_removeElementD_A", LIST_A, STRING_A);						//83) [A,D} -> remove(D) -> [D]
		testThreeElementList(CBD_set0_ABD,"CBD_set0_ABD", LIST_ABD, STRING_ABD);									//85) [C,B,D] -> set(0,A) -> [A,B,D]
		testThreeElementList(ABCD_removeFirst_BCD, "ABCD_removeFirst_BCD", LIST_BCD, STRING_BCD);					//86) [A,B,C,D] -> removeFirst() -> [B,C,D]
		testThreeElementList(BCDA_removeLast_BCD, "BCDA_removeLast_BCD", LIST_BCD, STRING_BCD);						//87) [B,C,D,A] -> removeLast() -> [B,C,D]
		testThreeElementList(BD_addAfterB_BCD, "BD_addAfterB_BCD", LIST_BCD, STRING_BCD);							//88) [B,D] -> addAfter(B,C) -> [B,C,D]
		testThreeElementList(ABCD_IterRemoveD_ABC, "ABCD_IterRemoveD_ABC", LIST_ABC, STRING_ABC);					//89) [A,B,C,D] -> iterator remove() after next() returns D -> [A,B,C]		
		testThreeElementList(ABCD_IterRemoveC_ABD, "ABCD_IterRemoveC_ABD", LIST_ABD, STRING_ABD);					//90) [A,B,C,D] -> iterator remove() after next() returns C -> [A,B,D]
		testThreeElementList(ABCD_IterRemoveB_ACD, "ABCD_IterRemoveB_ACD", LIST_ACD, STRING_ACD);					//91) [A,B,C,D] -> iterator remove() after next() returns B -> [A,C,D]
	...
	private IndexedUnsortedList<Integer> AB_addAfterCA_ACB() { //CHANGE
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.addToFront(ELEMENT_A);
	...
	private IndexedUnsortedList<Integer> AB_addAfterCB_ABC() {
		...
		list.add(ELEMENT_B);
		list.addToFront(ELEMENT_A);
		list.addAfter(ELEMENT_C, ELEMENT_B); //CHANGE
		return list;
	}
	...
	private IndexedUnsortedList<Integer> AB_add1C_CAB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.addToFront(ELEMENT_A);
	...
	private Scenario<Integer> AB_add1C_CAB = () -> AB_add1C_CAB();
	
	private IndexedUnsortedList<Integer> AB_add2C_CAB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.addToFront(ELEMENT_A);
	...
	private Scenario<Integer> AB_add2C_CAB = () -> AB_add2C_CAB();

	private IndexedUnsortedList<Integer> BC_set1_BA() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_C);
		list.addToFront(ELEMENT_B);
	...
	private Scenario<Integer> BC_set1_BA = () -> BC_set1_BA();
	
	private IndexedUnsortedList<Integer> CA_set0_BA() {
		IndexedUnsortedList<Integer> list = newList(); //CHANGE
		list.add(ELEMENT_C);
		list.add(ELEMENT_A);
		list.set(0, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> CA_set0_BA = () -> CA_set0_BA();

	private IndexedUnsortedList<Integer> CBD_set0_ABD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_D);
		list.addToFront(ELEMENT_B);
	...
	private Scenario<Integer> CBD_set0_ABD = () -> CBD_set0_ABD();	
	...
	private IndexedUnsortedList<Integer> A_addAfterA_AB() { //CHANGE
		IndexedUnsortedList<Integer> list = newList(); 
		list.add(ELEMENT_A);
	...
	private IndexedUnsortedList<Integer> A_add0_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.add(0, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_add0_BA = () -> A_add0_BA();

	private IndexedUnsortedList<Integer> A_add1_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.add(1, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_add1_AB = () -> A_add1_AB();
	...
	private IndexedUnsortedList<Integer> A_IterListRemoveA_empty() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
	...
	private Scenario<Integer> A_IterListRemoveA_empty = () -> A_IterListRemoveA_empty();
	

	private IndexedUnsortedList<Integer> AB_IterListRemoveA_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		ListIterator it = list.listIterator();
		it.next();
	...
	private Scenario<Integer> AB_IterListRemoveA_B = () -> AB_IterListRemoveA_B();

	private IndexedUnsortedList<Integer> AB_IterListRemoveB_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		ListIterator it = list.listIterator();
		it.next();
	...
	private Scenario<Integer> AB_IterListRemoveB_A = () -> AB_IterListRemoveB_A();

	private IndexedUnsortedList<Integer> ABC_IterListRemoveA_BC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		ListIterator it = list.listIterator();
	...
	private Scenario<Integer> ABC_IterListRemoveA_BC = () -> ABC_IterListRemoveA_BC();
	
	private IndexedUnsortedList<Integer> ABC_IterListRemoveB_AC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		ListIterator it = list.listIterator();
	...
	private Scenario<Integer> ABC_IterListRemoveB_AC = () -> ABC_IterListRemoveB_AC();

	private IndexedUnsortedList<Integer> ABC_IterListRemoveC_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		ListIterator it = list.listIterator();
	...
	private Scenario<Integer> ABC_IterListRemoveC_AB = () -> ABC_IterListRemoveC_AB();

	private IndexedUnsortedList<Integer> ABCD_removeFirst_BCD() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
	...
	private Scenario<Integer> ABCD_removeFirst_BCD = () -> ABCD_removeFirst_BCD();

	private IndexedUnsortedList<Integer> BCDA_removeLast_BCD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		list.addToRear(ELEMENT_D);
	...
	private Scenario<Integer> BCDA_removeLast_BCD = () -> BCDA_removeLast_BCD();

	private IndexedUnsortedList<Integer> BD_addAfterB_BCD() { //CHANGE
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.add(ELEMENT_D);
	...
	private Scenario<Integer> BD_addAfterB_BCD = () -> BD_addAfterB_BCD();
	...
	private IndexedUnsortedList<Integer> ABCD_removeElementB_ACD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
	...
	private Scenario<Integer> ABCD_removeElementB_ACD = () -> ABCD_removeElementB_ACD();

	private IndexedUnsortedList<Integer> ACB_remove1_AB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.addToRear(ELEMENT_C);
		list.addToRear(ELEMENT_B);
	...
	private Scenario<Integer> ACB_remove1_AB = () -> ACB_remove1_AB();

	private IndexedUnsortedList<Integer> AD_removeElementD_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.addToRear(ELEMENT_D);
		list.remove(ELEMENT_D);
		return list;
	}
	private Scenario<Integer> AD_removeElementD_A = () -> AD_removeElementD_A();

	private IndexedUnsortedList<Integer> ABCD_IterRemoveD_ABC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
	...
	private Scenario<Integer> ABCD_IterRemoveD_ABC = () -> ABCD_IterRemoveD_ABC();
	...
	private IndexedUnsortedList<Integer> ABCD_IterRemoveB_ACD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
	...
	private Scenario<Integer> ABCD_IterRemoveB_ACD = () -> ABCD_IterRemoveB_ACD();
	
	private IndexedUnsortedList<Integer> A_ListIterRemovePrevious_empty() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
	...
	private Scenario<Integer> A_ListIterRemovePrevious_empty = () -> A_ListIterRemovePrevious_empty();
	
	private IndexedUnsortedList<Integer> AB_ListIterRemovePrevious_B() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		ListIterator it = list.listIterator(1);
	...
	private Scenario<Integer> AB_ListIterRemovePrevious_B = () -> AB_ListIterRemovePrevious_B();
	
	private IndexedUnsortedList<Integer> AB_ListIterRemovePrevious_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
	...
	private Scenario<Integer> AB_ListIterRemovePrevious_A = () -> AB_ListIterRemovePrevious_A();
	
	private IndexedUnsortedList<Integer> ABC_ListIterRemovePrevious_BC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterRemovePrevious_BC = () -> ABC_ListIterRemovePrevious_BC();
	
	private IndexedUnsortedList<Integer> ABC_ListIterRemovePrevious_AC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterRemovePrevious_AC = () -> ABC_ListIterRemovePrevious_AC();
	
	private IndexedUnsortedList<Integer> ABC_ListIterRemovePrevious_AB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterRemovePrevious_AB = () -> ABC_ListIterRemovePrevious_AB();
	
	private IndexedUnsortedList<Integer> empty_ListIterAddA_A() {
		IndexedUnsortedList<Integer> list = newList();
		ListIterator it = list.listIterator();
		it.add(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> empty_ListIterAddA_A = () -> empty_ListIterAddA_A();
	...
	private IndexedUnsortedList<Integer> A_ListIterPreviousAddB_BA() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		ListIterator it = list.listIterator(1);
		it.previous();
	...
	private Scenario<Integer> A_ListIterPreviousAddB_BA = () -> A_ListIterPreviousAddB_BA();
	...
	private IndexedUnsortedList<Integer> AB_ListIterPreviousAddC_CAB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		ListIterator it = list.listIterator(2);
	...
	private Scenario<Integer> AB_ListIterPreviousAddC_CAB = () -> AB_ListIterPreviousAddC_CAB();
	
	private IndexedUnsortedList<Integer> AB_ListIterPreviousAddC_ACB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		ListIterator it = list.listIterator(2);
	...
	private Scenario<Integer> AB_ListIterPreviousAddC_ACB = () -> AB_ListIterPreviousAddC_ACB();
	...
	private IndexedUnsortedList<Integer> A_ListIterPreviousSetB_B() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		ListIterator it = list.listIterator(1);
		it.previous();
	...
	private Scenario<Integer> A_ListIterPreviousSetB_B = () -> A_ListIterPreviousSetB_B();
	...
	private IndexedUnsortedList<Integer> AB_ListIterNextSetC_AC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		ListIterator it = list.listIterator();
	...
	private Scenario<Integer> AB_ListIterNextSetC_AC = () -> AB_ListIterNextSetC_AC();
	
	private IndexedUnsortedList<Integer> AB_ListIterPreviousSetC_CB() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		ListIterator it = list.listIterator(2);
	...
	private Scenario<Integer> AB_ListIterPreviousSetC_CB = () -> AB_ListIterPreviousSetC_CB();
	
	private IndexedUnsortedList<Integer> AB_ListIterPreviousSetC_AC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		ListIterator it = list.listIterator(2);
	...
	private Scenario<Integer> AB_ListIterPreviousSetC_AC = () -> AB_ListIterPreviousSetC_AC();
	...
	private IndexedUnsortedList<Integer> ABC_ListIterNextSetD_ADC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterNextSetD_ADC = () -> ABC_ListIterNextSetD_ADC();
	
	private IndexedUnsortedList<Integer> ABC_ListIterNextSetD_ABD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterNextSetD_ABD = () -> ABC_ListIterNextSetD_ABD();
	
	private IndexedUnsortedList<Integer> ABC_ListIterPreviousSetD_DBC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterPreviousSetD_DBC = () -> ABC_ListIterPreviousSetD_DBC();
	
	private IndexedUnsortedList<Integer> ABC_ListIterPreviousSetD_ADC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterPreviousSetD_ADC = () -> ABC_ListIterPreviousSetD_ADC();
	
	private IndexedUnsortedList<Integer> ABC_ListIterPreviousSetD_ABD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_A);
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
	...
	private Scenario<Integer> ABC_ListIterPreviousSetD_ABD = () -> ABC_ListIterPreviousSetD_ABD();
	/////////////////////////////////
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testSetNeg1", testSet(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet1", testSet(scenario.build(), 1, contents[1], Result.NoException));
			printTest(scenarioName + "_testSet2", testSet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testGetNeg1", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testGet1", testGet(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testGet2", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(0), testIndexOf(scenario.build(), contents[0], 0));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddAfter" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfter" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[1], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfter" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[2], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
			...
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet1", testSet(scenario.build(), 1, contents[1], Result.NoException));
			printTest(scenarioName + "_testSet2", testSet(scenario.build(), 2, contents[2], Result.NoException));
			printTest(scenarioName + "_testSet3", testSet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testGetNeg1", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testGet1", testGet(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testGet2", testGet(scenario.build(), 2, contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testGet3", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(0), testIndexOf(scenario.build(), contents[0], 0));
