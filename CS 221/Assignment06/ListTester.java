...
public class ListTester {
	...
	private void runTests() {
		...
		//////////////////////////////////////////////////////////////////////////////////////CHANGE
		testThreeElementList(ABC_set0_ABD,"ABC_set0_ABD", LIST_ABD, STRING_ABD);
...
//			break;
	...
	//////////////////////////////////////////////////////////////////////////////////////CHANGE
	/** Scenario: [ABC] -> removeFirst() -> [BC]
	 * @return [BC]
	 */
	private IndexedUnsortedList<Integer> ABC_set0_ABD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_C);
		list.addToFront(ELEMENT_B);
		list.addToFront(ELEMENT_A);
	...
	private Scenario<Integer> ABC_set0_ABD = () -> ABC_set0_ABD();	
	
	
	//////////////////////////////////////////////////////////////////////////////////////CHANGE
	/** Scenario: [ABC] -> set2() -> [ABD]
	 * @return [BC]
	 */
