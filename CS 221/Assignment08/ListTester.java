...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_removeFirst_emptyList, "A_removeFront_emptyList");
		...
		testSingleElementList(BA_removeFirst_A, "BA_removeFront_A", LIST_A, STRING_A);
		//2-element to 3-element
		testThreeElementList(BC_addToFrontA_ABC, "BC_addToFrontA_ABC", LIST_ABC, STRING_ABC);
		//2-element to changed 2-element via set()
		testTwoElementList(BC_set1_BA, "BC_set1_BA", LIST_BA, STRING_BA);
		...
		testThreeElementList(CBD_set0_ABD,"CBD_set0_ABD", LIST_ABD, STRING_ABD);
		//4-element to changed 3-element removeFirst()
		testThreeElementList(ABCD_removeFirst_BCD, "ABCD_removeFirst_BCD", LIST_BCD, STRING_BCD);
		//4-element to changed 3-element removeLast()
		testThreeElementList(BCDA_removeLast_BCD, "BCDA_removeLast_BCD", LIST_BCD, STRING_BCD);
		//2-element to changed 3-element via addAfter()
		testThreeElementList(BD_addAfterB_BCD, "BD_addAfterB_BCD", LIST_BCD, STRING_BCD);
		
		testThreeElementList(ABCD_removeElementB_ACD, "ABCD_removeElementB_ACD", LIST_ACD, STRING_ACD);
		testTwoElementList(ACB_remove1_AB, "ACB_remove1_AB", LIST_AB, STRING_AB);
		testSingleElementList(AD_removeElementD_A, "AD_removeElementD_A", LIST_A, STRING_A);
		testThreeElementList(ABCD_IterRemoveD_ABC, "ABCD_IterRemoveD_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(ABCD_IterRemoveC_ABD, "ABCD_IterRemoveC_ABD", LIST_ABD, STRING_ABD);
		testThreeElementList(ABCD_IterRemoveB_ACD, "ABCD_IterRemoveB_ACD", LIST_ACD, STRING_ACD);
...
//			break;
	...
	/** #2 Scenario: empty list -> addToFront(A) -> [A] 
	...
	/** #6 Scenario: [BC] -> addToFront(A) -> [ABC]
	 * @return [ABC]
	 */
	...
	/** #10 Scenario: [A] -> addToFront(B) -> [B,A] 
	...
	/** #14 Scenario: [ABC] -> iterRemoveB -> [AC] 
	 * @return [AC]
	 */
	...
	/** #15 Scenario: [ABC] -> iterRemoveC -> [AB] 
	 * @return [AB]
	 */
	...
	/** #16 Scenario: [ABCD] -> removeFirst() -> [BCD] 
	 * @return [BCD]
	 */
	...
	/** #17 Scenario: [ABCD] -> removeLast() -> [BCD] 
	 * @return [BCD]
	 */
	...
	/** #18 Scenario: [ABCD] -> removeLast() -> [BCD] 
	 * @return [BCD]
	 */
	private IndexedUnsortedList<Integer> BD_addAfterB_BCD() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.addToRear(ELEMENT_D);
		list.addAfter(ELEMENT_C, ELEMENT_D);
		return list;
	}
	private Scenario<Integer> BD_addAfterB_BCD = () -> BD_addAfterB_BCD();
	
	/** #19 Scenario: [ABC] -> iterRemoveA -> [BC] 
	 * @return [AB]
	 */
	...
	/** #20 Scenario: [ABCD] -> removeElementB -> [ACD] 
	 * @return [ACD]
	 */
	...
	/** #22 Scenario: [AD] -> removeElementD -> [A] 
	 * @return [A]
	 */
	...
	/** #23 Scenario: [ABCD] -> iterRemoveD -> [ABC] 
	 * @return [ABC]
	 */
	...
	/** #24 Scenario: [ABCD] -> iterRemoveD -> [ABC] 
	 * @return [ABC]
	 */
	...
	/** #25 Scenario: [ABCD] -> iterRemoveC -> [ABD] 
	 * @return [ABD]
	 */
