...
//declaration of vars
  ...
  //!!!!!!!!!!LOG FILE STUFF!!!!!!!!!!!!!!
  ofstream logFileLocation("logFile.txt", ios::app);
  logFileLocation << "STARTING LOG FILE ON: " << time(NULL) << endl;
  logFileLocation.close();
  //!!!!!!!!!!LOG FILE STUFF!!!!!!!!!!!!!!
...
//!!!!!!!!!!LOG FILE STUFF!!!!!!!!!!!!!!
logFileLocation.open("logFile.txt", ios::app);
logFileLocation << "Time: " << time(NULL) <<" Option: " << userInput << endl;
if (logFileLocation.fail())
  cout << "Something went wrong when logging options" << endl;
logFileLocation.close();
...
//!!!!!!!!!!LOG FILE STUFF!!!!!!!!!!!!!!
  logFileLocation.open("logFile.txt", ios::app);
  logFileLocation << "Time: " << time(NULL) << " Measurements: " << varA << " " << varB << " " << varC << endl;
  if (logFileLocation.fail())
    cout << "Something went wrong when logging measurements" << endl;
  logFileLocation.close();
//!!!!!!!!!!LOG FILE STUFF!!!!!!!!!!!!!!
}
