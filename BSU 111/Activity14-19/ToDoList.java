...
public class ToDoList implements ToDoListInterface {
	...
	public Task getWork() {
		...
		boolean truthBool = true;
		for (int i = 0; i < this.tasks.size(); i++) {
			truthBool = this.tasks.get(i).isCompleted();
//			System.out.println(truthBool);
//			System.out.println(i);
			...
			if ((i == this.tasks.size()-1) && (truthBool)) {
				return new Task("null");
			}
		}
...
//				System.out.println(this.tasks.get(i).compareTo(this.tasks.get(j)));
